...
<footer class="mt-auto border-t border-mustard/10 bg-background-dark py-8 px-6 mb-24 md:mb-0 reveal relative">
    <div class="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <div class="flex items-center gap-6">
            ...
            <a class="text-mustard/60 hover:text-mustard transition-colors" href="https://dreamsequence3.bandcamp.com" target="_blank" rel="noopener" aria-label="Visit our Bandcamp">
